...
namespace Mongo.Web
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            SD.OrderAPIBase = builder.Configuration["ServiceUrls:OrderAPI"]; //get the base url from appsettings.json
            ...
            builder.Services.AddScoped<IOrderService, OrderService>(); //for using order service
